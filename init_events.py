...
event2 = Event(name="Asia Europe Meetup", description="Meetup for all asian and europe people",
                     price="$22.99", image="http://cdn.eso.org/images/newsfeature/ann15033a.jpg",
                     category=category_culture, user_id = User2.id)
...
cookevent1 = Event(
    ...
    image="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Peking_Duck_1.jpg/800px-Peking_Duck_1.jpg",
     price="$8", category=category_culinary, user_id = User1.id)
